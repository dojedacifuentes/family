...
function Inventario({ bienes, onErr }: { bienes: any[]; onErr: () => void }) {
  ...
  const propios = bienes.filter((b: any) => b.clase.startsWith("propio") || b.clase === "reservado_art150");
  return (
